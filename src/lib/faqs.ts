export const faqs = [
  {
    ...
    question: "Can sewer pipe lining avoid excavation?",
    answer:
      "Sometimes. If the pipe is still a good candidate, CIPP lining can reduce disruption. If the pipe is collapsed or badly offset, excavation may still be the right repair.",
  },
  {
    category: "Residential Sewer & Water",
    question: "What if sewer or water service is not working now?",
  ...
  {
    category: "Commercial Sewer & Water",
    question: "Does All-Star Utilities work with contractors and developers?",
    answer: "Yes. We work with developers, general contractors, commercial owners, managers, and facilities teams.",
  },
  {
    category: "Commercial Sewer & Water",
    question: "Is pipe lining available for commercial projects?",
